  ...
  useEffect(() => {
    ...
    navigator.geolocation.getCurrentPosition(
      async ({ coords }: GeolocationPosition) => {
        ...
        setPlaceholder(
          name
            ? t("nav.searchNear", { location: name })
      ...
      >
        ...
        <div className="dropmenu__body">
          ...
          <div className="dropmenu__cities-header">
            <span className="dropmenu__item dropmenu__item--label">
              {t("nav.cities")}
            </span>
            <a
              href={`/${locale}/ciutats`}
              className="dropmenu__all-cities"
              onClick={() => setMenuOpen(false)}
            >
              {t("nav.allCitiesLink")}
            </a>
          ...
          <a
            href="https://www.instagram.com/coslot/"
            role="menuitem"
            target="_blank"
        ...
        <div className="dropmenu__footer">
          <div className="dropmenu__item dropmenu__item--label">
            {t("lang.label")}
          </div>
          {LOCALES.map((l) => (
            <button
        ...
        <div className="dropmenu__copyright">
          ...
          <nav>
            <a
              href={`/${locale}/privacitat`}
              onClick={() => setMenuOpen(false)}
            >
              {t("nav.privacy")}
            </a>
            <a href={`/${locale}/termes`} onClick={() => setMenuOpen(false)}>
              {t("nav.terms")}
            </a>
            <a href={`/${locale}/mapa-web`} onClick={() => setMenuOpen(false)}>
              Mapa
            </a>
          </nav>
        </div>
